...
// NewDealerProtobufClient creates a Protobuf client that implements the Dealer interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewDealerProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Dealer {
	...
	urls := [7]string{
		serviceURL + "GetInputStorageClaim",
...
func (c *dealerProtobufClient) GetInputStorageClaim(ctx context.Context, in *StorageClaimRequest) (*StorageClaim, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Dealer")
	ctx = ctxsetters.WithMethodName(ctx, "GetInputStorageClaim")
	caller := c.callGetInputStorageClaim
		...
		caller = func(ctx context.Context, req *StorageClaimRequest) (*StorageClaim, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return c.callGetInputStorageClaim(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
...
func (c *dealerProtobufClient) callGetInputStorageClaim(ctx context.Context, in *StorageClaimRequest) (*StorageClaim, error) {
...
// NewDealerJSONClient creates a JSON client that implements the Dealer interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewDealerJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Dealer {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *dealerJSONClient) GetInputStorageClaim(ctx context.Context, in *StorageClaimRequest) (*StorageClaim, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Dealer")
	ctx = ctxsetters.WithMethodName(ctx, "GetInputStorageClaim")
	caller := c.callGetInputStorageClaim
...
func (c *dealerJSONClient) callGetInputStorageClaim(ctx context.Context, in *StorageClaimRequest) (*StorageClaim, error) {
	out := new(StorageClaim)
...
// NewDealerServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewDealerServer(svc Dealer, opts ...interface{}) TwirpServer {
...
func (s *dealerServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *dealerServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// DealerPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const DealerPathPrefix = "/twirp/Dealer/"

func (s *dealerServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Dealer")
	...
	switch method {
	case "GetInputStorageClaim":
		s.serveGetInputStorageClaim(ctx, resp, req)
		return
...
func (s *dealerServer) serveGetInputStorageClaim(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveGetInputStorageClaimJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetInputStorageClaimProtobuf(ctx, resp, req)
	default:
...
func (s *dealerServer) serveGetInputStorageClaimJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInputStorageClaim")
	...
	handler := s.Dealer.GetInputStorageClaim
		...
		handler = func(ctx context.Context, req *StorageClaimRequest) (*StorageClaim, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Dealer.GetInputStorageClaim(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*StorageClaim)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *StorageClaim and nil error while calling GetInputStorageClaim. nil responses are not supported"))
		return
	}
...
func (s *dealerServer) serveGetInputStorageClaimProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInputStorageClaim")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *dealerServer) serveNotify(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *dealerServer) serveNotifyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Notify")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Empty and nil error while calling Notify. nil responses are not supported"))
		return
	}
...
func (s *dealerServer) serveNotifyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Notify")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *dealerServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *dealerServer) ProtocGenTwirpVersion() string {
	return "v8.1.2"
}
...
func (s *dealerServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "", "Dealer")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
